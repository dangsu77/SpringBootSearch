...
class WNCommon {
	...
	private Logger LOGGER = LoggerFactory.getLogger(WNCommon.class);
	...
	public WNCommon(Logger LOGGER, boolean isDubug) {
		this.search = new Search();
		this.LOGGER = LOGGER;
